            ...
            <div className = "block">
              ...
              <div className = "about">
                <ul>
                  ...
                  <li> I create full stack web and mobile apps for the DALI Lab. Previously I was a software engineer intern at Alarm.com, a smart home app. See more <a href = "#jobs">here</a></li>
