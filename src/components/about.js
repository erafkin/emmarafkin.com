            ...
            <div className = "block">
              ...
              <div className = "about">
                <ul>
                  ...
                  <li> I create full stack web and mobile apps for the DALI Lab. Starting August 2021 I will be working as a Software Engineer for JHUAPL. See more <a href = "#jobs">here</a></li>
